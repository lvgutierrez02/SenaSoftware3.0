...
namespace Seguimiento.API.Controllers
{
    ...
    public class EmployeesController : ControllerBase
    {
        ...
        [HttpDelete("{id}")]
        public async Task<IActionResult> DeleteEmployeeForCompany(Guid companyId, Guid id)//Recopilamos el companyId de la ruta raíz y el id del empleado del argumento pasado
        {
            var company = await _repository.Company.GetCompanyAsync(companyId, trackChanges: false);
            ...
            var employeeForCompany =await _repository.Employee.GetEmployeeAsync(companyId, id, trackChanges: false); // verificamos la entidad del empleado
            ...
            await _repository.SaveAsync();//Guardamos cambios
